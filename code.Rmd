...
```{r estimating ols and fixed model fits, echo=F, comment=NA}
  ...
  pdata <- ddply(pdata, ~Country + Date, function(xframe){
    ...
    fit <- as.numeric(fit)# because we worked with logs of arrivals
...
## we will plot 3 countries in order to have a clear picture
...
\subsubsection{Statistics for accuracy}
