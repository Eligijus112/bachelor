...
\vskip 120pt
\large Scientific supervisor (PhD, Vaidotas Zemlys - Balevičius) \underline{\hskip 95pt}
\vskip 150pt
\end{titlepage}
...
Šio darbo tikslas yra sudaryti turizmo modelį OECD šalims. Naudojantis pasaulinio banko (World Bank), OECD ir Merilando Universiteto duomenų baze (the Department of Homeland Security Center of Excellence led by the Maryland University) duomenimis nustatėme, kad turistų skaičius tiesiškai priklauso nuo teroristinių įvykių skaičiaus, kaimyninių valstybių metinių darbo valandų skaičiaus ir nuo BVP (bendrasis visdaus produktas) vienam asmeniui. Tiesinės priklausomybės įrodymui naudojome panelinį modelį.
